...
# No more slop: taste and accountability in the age of cheap tokens
...
- Pick one “slop hotspot” in your org (docs, code reviews, agent runs, analytics, support macros) and add **one** explicit quality gate this week.
- Write down your team’s definition of “done” for AI-assisted work (tests, evals, citations, threat model, rollback).
- The next time someone pushes for speed without clarity, try the mantra—politely but firmly: **no more slop**.
